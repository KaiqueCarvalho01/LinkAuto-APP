...
- [ ] T018 [P] [US1] Add contract tests for /auth/* and /users/me in linkauto-backend/tests/contract/test_us1_auth_profile_contract.py
...
- [ ] T022 [US1] Implement auth service (register/login/refresh/password reset trigger) in linkauto-backend/app/services/auth_service.py
...
- [ ] T030 [P] [US2] Add contract tests for /instructors/*/slots, /bookings, /bookings/{id}/confirm, and /bookings/{id}/cancel in linkauto-backend/tests/contract/test_us2_booking_contract.py
- [ ] T031 [P] [US2] Add integration tests for RN02, RN04, penalty window, and first-write-wins in linkauto-backend/tests/integration/test_us2_booking_rules.py
...
- [ ] T042 [P] [US3] Add contract tests for /bookings/{id}/messages and /instructors/{id}/reviews in linkauto-backend/tests/contract/test_us3_message_review_contract.py
...
- [ ] T048 [US3] Implement review listing endpoint for instructor profile in linkauto-backend/app/api/v1/reviews.py
...
- Booking is the system core aggregate. Any change in linkauto-backend/app/domain/booking.py or linkauto-backend/app/services/booking_service.py requires re-running T041 and T052 before advancing phase.
