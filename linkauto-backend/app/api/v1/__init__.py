...
from app.api.v1 import admin_instructors, auth, foundation, instructor_documents, users, slots, bookings, admin_bookings, instructor_search, booking_messages, reviews
